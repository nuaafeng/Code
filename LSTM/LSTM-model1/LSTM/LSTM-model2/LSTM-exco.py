...
config = {
    ...
    'save_path': './models/model_exco_300.ckpt'  # Your model will be saved here.
}

#数据加载
same_seed(config['seed'])
train_data, test_data = pd.read_excel('./输入特征.xlsx').values[0:4000,], pd.read_excel('./输入特征.xlsx').values
...
save_pred(preds, 'pred-model-1.csv')